  ...
  return (
    <>
      ...
      <div className="flex w-full flex-col space-y-2">
        <div
          className={`flex w-full border-[1px] border-[#333] rounded-md cursor-pointer  hover:shadow-sm  hover:shadow-blue-500 transition-all ${
        ...
        >
          ...
          <div className="flex w-2/3 flex-col justify-start items-center text-[#282828] text-center">
        ...
        <div
          className={`flex  w-full border-[1px] border-[#333] rounded-md cursor-pointer  hover:shadow-sm  hover:shadow-blue-500 transition-all overflow-hidden relative ${
      ...
      <div className="flex w-full flex-col space-y-2 sm:space-x-2 sm:space-y-0 mt-2">
        <div
          className={`flex w-full border-[1px] border-[#333] rounded-md cursor-pointer hover:shadow-sm  hover:shadow-blue-500 transition-all ${
